...
import com.example.helpdesk.model.guestModel.CreateAccountModel
import com.google.firebase.auth.UserProfileChangeRequest

class CreateAccountController(private var createAccountModel: CreateAccountModel, var view: CreateAccount) {
    fun signOut() {
